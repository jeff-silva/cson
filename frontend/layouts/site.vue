          ...
          <div class="d-flex flex-column h-100">
            <v-card>
              ...
              <v-card-text>
                ...
                <br />
                <nuxt-link to="/cash"> Cash: 26 </nuxt-link>
                <nuxt-link to="/gold"> Gold: 26 </nuxt-link>,
                <br />
                <nuxt-link to="/level"> Level: 0 </nuxt-link>,
                <nuxt-link to="/cash"> Exp: 26 </nuxt-link>
                <br /><br />
              </v-card-text>
            </v-card>
        ...
        <v-main>
          <v-app-bar>
            <template v-slot:prepend>
              <v-app-bar-nav-icon class="d-lg-none" @click="menu.drawer = !menu.drawer" />
            </template>
            ...
            <template v-slot:append>
              <v-btn icon="mdi-dots-vertical" class="d-lg-none" @click="invite.drawer = !invite.drawer" />
            </template>
          </v-app-bar>

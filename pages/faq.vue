<template>
  ...
  <v-sheet class="pa-3" v-if="faq.filteredData.length==0">
  ...
  const faq = ref({
    ...
    data: [
      ...
      },
      {
        ...
        answer: 'Os servidores estão localizados em todo o mundo, a fim de garantir a qualidade da comunicação para todos os jogadores.',
        links: [],
      },
      {
        question: 'Por que este jogo é necessário se houver uma versão para desktop?',
        answer: 'A vantagem deste produto em sua disponibilidade em locais onde o jogo desktop não funciona ou então (trabalho, laboratório de informática).',
        links: [],
      },
      {
      ...
      },
      {
        ...
        answer: 'Sua habilidade é reduzida porque você muitas vezes morre e mata jogadores fracos. Para jogadores fracos, menos habilidade é dada do que para jogadores fortes, tente observar a habilidade média dos jogadores na entrada do servidor e sempre jogue com oponentes mais fortes.',
        links: [],
      },
      {
      ...
      },
      {
        ...
        answer: 'Você terá apenas 1 carregador de munição restante se você pegar a arma de outra pessoa. Você terá tantas munições quantas sobraram antes de ser largada, se for sua arma ou se você a recebeu após a morte do inimigo.',
        links: [],
      },
      {
        question: 'Com que frequência as estatísticas são atualizadas?',
        answer: 'As estatísticas são atualizadas a cada 1 minuto ou mais rápido. As classificações dos jogadores são atualizadas à noite pelo horário do servidor.',
        links: [],
      },
      {
      ...
      },
      {
        ...
        answer: 'Elo Rating System. Stats are counted only on Rating Maps (icon plus) and only when more than 4 people play on them. Rating Maps are classic modes like cs_, de_ (except cs_untitled and cs_16fighter).',
        links: ['/rating'],
      },
      {
        question: 'How to get a knife?',
        answer: 'We have several ways to get a knife: Holiday Events, Achievements, For killing with a knife (Level System).',
      ...
      },
      {
        ...
        answer: 'As estatísticas do jogo são atualizadas a cada hora. Complete as tarefas do jogo e você pode aumentar sua posição.',
        links: ['/rating'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Make sure your don\'t have any VPN or CDN plugins in browser activated, for example: friGate. Also you can to tune Network Optimization. You should try it both on and off',
        links: ['/settings'],
      },
      {
      ...
      },
      {
        ...
        answer: 'Servidores clássicos permitem que você jogue por 20 rodadas, após o que o jogador vai para a página principal. Não existem restrições em servidores privados, você pode alugá-los em uma página especial ou encontrá-los na página principal.',
        links: [],
      },
      {
        question: 'As skins de armas serão adicionadas?',
        answer: 'We add them sometimes during Events, but mostly we use classic models. You can also select models from other CS versions in the settings.',
        links: ['/settings'],
      },
      {
        question: 'O console funciona?',
        answer: 'It works, but not completely, you can try to enter console commands into the game chat using the Y key, where the ";" symbol is needed at the beginning',
        links: [],
      },
      {
        question: 'How to add my map?',
        answer: 'You can offer your card to the administrator in Discord or by email. We will check and decide if we can add it.',
        links: ['https://discord.gg/HW5XRA'],
      },
      {
        question: 'How to promote server so everyone can see it and join?',
        answer: 'Click on button in the top right corner of the screen when you are in the game and your current server will appear in the right block on the website and in Discord.',
      ...
      },
      {
        ...
        answer: 'Our project has moved to a new Domain. Please tell your friends! Old domain is not working. It is no longer supported by us.',
        links: ['/'],
      },
      {
        question: 'The problem with the rented server!',
        answer: 'If you have any problems with the server, please contact the Project Administration in the Discord or by e-mail.',
        links: ['https://discord.gg/HW5XRA'],
      },
      {
      ...
      },
      {
        ...
        answer: 'There may be many reasons, it is possible that you played too well or poorly. Anyway, we can\'t interfere in the affairs of private servers.',
        links: [],
      },
      {
        question: 'How do I open a server in my country?',
        answer: 'We can try to open a server in your country if you can bring enough people from there. In other words, the server will be closed soon.',
        links: [],
      },
      {
        question: 'I can\'t register',
        answer: 'Try to turn off AdBlock or alternative plugins in your browser. If this did not help, then write to us in the Discord or by E-mail',
        links: ['https://discord.gg/HW5XRA'],
      },
      {
      ...
      },
      {
        ...
        answer: 'If a player really behaves inappropriately, you can create a Vote on this player\'s Kick from the server.',
        links: [],
      },
      {
        question: 'Do you have tournaments?',
        answer: 'Sometimes players hold big tournaments, and we contribute to this with prizes. Follow the news of the project.',
        links: ['/forum'],
      },
    ],
  });
